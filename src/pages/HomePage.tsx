          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              },
              {
                name: "Miami",
                image:
                  "https://images.unsplash.com/photo-1514214246283-d427a95c5d2f?q=80&w=2080&auto=format&fit=crop",
              },
              {
                name: "Denver",
                image:
                  "https://images.unsplash.com/photo-1572204097183-e1ab140342ed?q=80&w=2070&auto=format&fit=crop",
              },
              {
                name: "Chicago",
                image:
      ...
      <section className="bg-hotel-primary py-16 px-4">
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          <p className="text-lg mb-6">
            Subscribe to our newsletter and get exclusive offers directly in
            your inbox.
          </p>
